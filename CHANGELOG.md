...
- **Certificates** endpoints documented on the `/beta` surface: `GET /beta/certificates` (list) and `GET /beta/certificates/{id}` (get a single certificate), on the API Reference.
### Changed
